...
====================
Run this ONCE to create ayansh.db and populate it with initial data.
...
def seed_products(conn: sqlite3.Connection) -> None:
    ...
    products = [
        ...
        },
        {
            ...
            "name":               "15U Rack 400×550 Wall Mount",
            "brand":              "Ayansh Infocom",
            ...
            "offer": {
                "code":         "WALL3200",
                "description":  "Special discounted price: ₹3,200 (MRP ₹4,500)",
                "discount_pct": 0.289,
...
def seed_knowledge(conn: sqlite3.Connection) -> None:
    ...
    chunks = [
        ...
        # ── 42U Server Rack ─────────────────────────────────
        {
            ...
            "content":  (
                "• External Dimensions: 600 mm (W) × 1000 mm (D) × 2055 mm (H)\n"
        ...
        # ── 15U Wall Rack ───────────────────────────────────
        {
            ...
            "title":    "15U Rack 400×550 Wall Mount — Specifications",
            "content":  (
                "• External Dimensions: 600 mm (W) × 400/550 mm (D) × ~770 mm (H)\n"
        ...
        # ── Mikrotik ────────────────────────────────────────
        {
            ...
            "content":  (
                ...
                "• Ports: 5 × 10/100/1000 Gigabit Ethernet\n"
        ...
        # ── Aruba Switch ─────────────────────────────────────
        {
            ...
            "content":  (
                "• Ports: 24 × Gigabit RJ45, 4 × 1/10GbE SFP/SFP+\n"
    ...
    conn.executemany(
        ...
        VALUES (:category, :title, :content, :keywords)
        """,
        chunks,
    )
    conn.commit()
    print(f"  [✓] {len(chunks)} knowledge chunks seeded.")


def seed_company_info(conn: sqlite3.Connection) -> None:
    ...
    conn.executemany(
        "INSERT INTO company_info (key, value) VALUES (?, ?)", info
    )
    conn.commit()
...
def main() -> None:
    print("\n  Ayansh Infocom -- Database Seed Script")
    print("  " + "-" * 40)
